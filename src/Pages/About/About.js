			...
			<section className='about'>
				<div className='about-wrapper'>
					...
					<ul className='about-links-wrapper'>
						...
						<li>
							<Link to={'https://github.com/Rahul-Palamarthi'} target='_blank'>
								github
							</Link>
						</li>
						<li>
							<Link to={'https://www.linkedin.com/in/rahul-palamarthi/'} target='_blank'>
								linkedin
							</Link>
						</li>
						<li>
							<Link to={'https://rahul-palamarthi.github.io/Web-Portfolio/'} target='_blank'>
								portfolo
							</Link>
						</li>
					</ul>
